...
builder.Services.AddScoped<IUsuarioRepositoryy,UsuarioRepository>();


var key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("PalabraScreta1994"));
...
using(var ambiente = app.Services.CreateScope())
{
     ...
     try 
     {
        ...
        await LoadData.InsertData(context,userManager);
